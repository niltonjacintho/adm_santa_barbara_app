...
import 'listadocumentos_controller.dart';

import 'package:data_tables/data_tables.dart';
import 'dart:io' show Platform;
import 'package:flutter/foundation.dart';

class ListadocumentosPage extends StatefulWidget {
  final String title;
  const ListadocumentosPage({Key key, this.title = "Listadocumentos"})
      : super(key: key);

  @override
  _ListadocumentosPageState createState() => _ListadocumentosPageState();
}
...
class _ListadocumentosPageState
    extends ModularState<ListadocumentosPage, ListadocumentosController> {
